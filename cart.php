...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<br /><br />
			<?php
				$query = "SELECT * FROM businesses ORDER BY product_ID ASC";
			...
			<div class="col-md-4">
				<form method="post" action="cart.php?action=add&id=<?php echo $row["product_ID"]; ?>">
					<div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">
						<img src="dashboard/products/<?php echo $row["filename"]; ?>" class="img-responsive" /><br />

						<h4 class="text-info"><?php echo $row["productname"]; ?></h4>

						<h4 class="text-danger">$ <?php echo $row["sellingprice"]; ?></h4>
